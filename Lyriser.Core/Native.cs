...
#pragma warning restore CS0649
	...
	{
		public int GetWeight() => ((delegate* unmanaged[Stdcall]<IDWriteFontFace3*, int>)lpVtbl[37])((IDWriteFontFace3*)Unsafe.AsPointer(ref this));

		public int GetStretch() => ((delegate* unmanaged[Stdcall]<IDWriteFontFace3*, int>)lpVtbl[38])((IDWriteFontFace3*)Unsafe.AsPointer(ref this));

		public Lyriser.Core.DirectWrite.FontStyle GetStyle()
			=> ((delegate* unmanaged[Stdcall]<IDWriteFontFace3*, Lyriser.Core.DirectWrite.FontStyle>)lpVtbl[39])((IDWriteFontFace3*)Unsafe.AsPointer(ref this));
...
#pragma warning restore CS0649
	...
	unsafe struct IDWriteTextFormat
	{
		...
		public Lyriser.Core.DirectWrite.TextAlignment GetTextAlignment()
			=> ((delegate* unmanaged[Stdcall]<IDWriteTextLayout*, Lyriser.Core.DirectWrite.TextAlignment>)lpVtbl[11])((IDWriteTextLayout*)Unsafe.AsPointer(ref this));

		public Lyriser.Core.DirectWrite.WordWrapping GetWordWrapping()
			=> ((delegate* unmanaged[Stdcall]<IDWriteTextFormat*, Lyriser.Core.DirectWrite.WordWrapping>)lpVtbl[13])((IDWriteTextFormat*)Unsafe.AsPointer(ref this));
...
#pragma warning restore CS0649
	...
	unsafe struct IDWriteTextLayout
	{
		...
		public float GetMaxWidth() => ((delegate* unmanaged[Stdcall]<IDWriteTextLayout*, float>)lpVtbl[42])((IDWriteTextLayout*)Unsafe.AsPointer(ref this));
		...
		public Foundation.HRESULT GetClusterMetrics(Lyriser.Core.DirectWrite.ClusterMetrics* clusterMetrics, uint maxClusterCount, uint* actualClusterCount)
			=> ((delegate* unmanaged[Stdcall]<IDWriteTextLayout*, Lyriser.Core.DirectWrite.ClusterMetrics*, uint, uint*, Foundation.HRESULT>)lpVtbl[62])((IDWriteTextLayout*)Unsafe.AsPointer(ref this), clusterMetrics, maxClusterCount, actualClusterCount);
		...
		public Foundation.HRESULT HitTestTextRange(uint textPosition, uint textLength, float originX, float originY, Lyriser.Core.DirectWrite.HitTestMetrics* hitTestMetrics, uint maxHitTestMetricsCount, uint* actualHitTestMetricsCount)
			=> ((delegate* unmanaged[Stdcall]<IDWriteTextLayout*, uint, uint, float, float, Lyriser.Core.DirectWrite.HitTestMetrics*, uint, uint*, Foundation.HRESULT>)lpVtbl[66])((IDWriteTextLayout*)Unsafe.AsPointer(ref this), textPosition, textLength, originX, originY, hitTestMetrics, maxHitTestMetricsCount, actualHitTestMetricsCount);
